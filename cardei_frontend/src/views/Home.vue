                ...
                <div class="row">
                    ...
                    <div class="left-ads-display col-lg-9">
                        ...
                        <Pagination 
                            ...
                            :item="listMovie.length"
                            @page-changed="loadListMovies"
                        />
                    </div>
                </div>
            </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            async loadListMovies(page_number) {
                ...
                try {
                    ...
                    if (response.status < 400) {
                        this.listMovie = response.data.result;
...
<style scoped>
    .ab-info-main.py-md-5.py-4.editContent {
        padding-left:3rem;
        padding-right: 3rem;
    }
</style>